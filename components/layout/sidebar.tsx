...
import { Building2, FolderKanban, Library, LogOut, MessageSquare, Settings, ShieldCheck, Users } from "lucide-react";
...
function SidebarContent({ viewer, currentPath, onNavigate }: { viewer: ViewerContext; currentPath: string; onNavigate?: () => void }) {
  ...
  return <div className="flex h-full min-h-0 flex-col">
    <div className="flex h-[58px] items-center border-b border-sidebar-border px-4">
      <Link href="/projects" className="flex min-w-0 items-center gap-2.5" onClick={onNavigate}>
